                            ...
                            <Card className='solutionpath-box'>
                                <CardContent>
                                    ...
                                    <Box className='contact-info'>
                                        ...
                                        <Box className={`status ${checkedOne}`} disabled={!checkedOne}>
                                            <Typography  >Step - 2
                                                {
                                                    checkedOne && (
                                                        <Checkbox
                                            ...
                                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                                <Tabs aria-label="basic tabs example" value={value1} onChange={handleChange1}>
                                                    <Tab disabled={!checkedOne} icon={<ArticleIcon />} {...a11yProps(0)} />
                                                    <Tab disabled={!checkedOne} icon={<ConstructionIcon />} {...a11yProps(1)} />
                                                    <Tab disabled={!checkedOne} icon={<InsertDriveFileIcon />} {...a11yProps(2)} />
                                                    <Tab disabled={!checkedOne} icon={<PhotoIcon />} {...a11yProps(3)} />
                                                    <Tab disabled={!checkedOne} icon={<VideoLibraryIcon />} {...a11yProps(4)} />

                                                </Tabs>
                                            </Box>
                                            <Card className={`status ${checkedOne}`} disabled={!checkedOne}>
                                                <CardContent>
                                        ...
                                        <Box className={`status ${checkedTwo}`} disabled={!checkedTwo}>
                                            <Typography  >Step - 3
                                                {
                                                    checkedTwo && (
                                                        <Checkbox
                                            ...
                                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                                <Tabs aria-label="basic tabs example" value={value2} onChange={handleChange2}>
                                                    <Tab disabled={!checkedTwo} icon={<ArticleIcon />} {...a11yProps(0)} />
                                                    <Tab disabled={!checkedTwo} icon={<ConstructionIcon />} {...a11yProps(1)} />
                                                    <Tab disabled={!checkedTwo} icon={<InsertDriveFileIcon />} {...a11yProps(2)} />
                                                    <Tab disabled={!checkedTwo} icon={<PhotoIcon />} {...a11yProps(3)} />
                                                    <Tab disabled={!checkedTwo} icon={<VideoLibraryIcon />} {...a11yProps(4)} />

                                                </Tabs>
                                            </Box>
                                            <Card className={`status ${checkedTwo}`} disabled={!checkedTwo}>
                                                <CardContent>
